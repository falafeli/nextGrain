...
export default function SurveyQuestion15Page() {
  return (
    <div className="bg-[#f7f7f7] relative w-full h-screen max-w-md mx-auto" data-name="SurveyQuestion15">
      {/* Status Bar */}
      ...
      <div className="absolute font-bold leading-none left-[49px] text-black text-2xl text-left text-nowrap top-[174px]">
        <p className="block leading-normal whitespace-pre">Personality</p>
      </div>
      ...
      <div className="absolute font-bold leading-none left-[47px] text-black text-base text-left top-[293px] w-[334px]">
        <p className="block leading-normal">I enjoy figuring out how things work and often take things apart to understand them.</p>
      </div>
      ...
      <div className="absolute left-14 top-[396px] w-[315px] space-y-4">
        ...
        <div className="flex items-center space-x-3">
          ...
          />
          <label className="text-black text-base">Doesn't fit at all</label>
        </div>
        ...
        <div className="flex items-center space-x-3">
          <input
            ...
            className="w-4 h-4 text-nextgrain-blue bg-gray-100 border-gray-300 focus:ring-nextgrain-blue focus:ring-2"
          />
          <label className="text-black text-base">Fits somewhat</label>
        </div>
        ...
        <div className="flex items-center space-x-3">
          <input
            ...
            className="w-4 h-4 text-nextgrain-blue bg-gray-100 border-gray-300 focus:ring-nextgrain-blue focus:ring-2"
          />
          <label className="text-black text-base">Fits well</label>
        </div>
        ...
        <div className="flex items-center space-x-3">
          <input
            ...
            className="w-4 h-4 text-nextgrain-blue bg-gray-100 border-gray-300 focus:ring-nextgrain-blue focus:ring-2"
          />
          <label className="text-black text-base">Totally fits</label>
        </div>
      </div>
      ...
      <div className="absolute bg-[#90b9df] box-border flex flex-row gap-2.5 h-[29px] items-center justify-center p-5 rounded-lg top-[600px] w-[134px] left-[60%] transform -translate-x-1/2">
        <Link href="/survey-question-30" className="w-full text-center">
