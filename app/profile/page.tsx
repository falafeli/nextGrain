    ...
    <div className="bg-white relative w-full h-screen max-w-md mx-auto">
      ...
      <div className="flex items-center justify-center h-full">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-nextgrain-black mb-4">Profile</h1>
          <p className="text-nextgrain-black opacity-70">Your profile settings and information</p>
        </div>
      </div>
